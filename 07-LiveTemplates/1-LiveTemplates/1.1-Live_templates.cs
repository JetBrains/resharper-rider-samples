...
namespace JetBrains.ReSharper.Koans.LiveTemplates
{
    ...
    public class LiveTemplates
    {
        ...
        //    Go to ReSharper → Tools → Templates Explorer → Live Templates → C# and select the "psvm" template 
        ...
        //    Go to ReSharper → Tools → Templates Explorer → Live Templates → C# and select the "asrt" template 
    ...
    //    Go to ReSharper → Tools → Templates Explorer → Live Templates → C#
    ...
    //    Save the template and test here:
